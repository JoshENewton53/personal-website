...
const sections = [
  ...
  },
  {
    label: "Blog",
    href: "/blog",
    desc: "Thoughts, insights & updates",
    accent: "#1d9e75",
    icon: "◫",
  },
  {
  ...
  },
  {
    label: "Pets Wall",
    href: "/pets",
    desc: "Photos & stories about my animals",
    accent: "#c8a84b",
    icon: "◈",
  },
  {
    label: "Video Games",
    href: "/games",
    desc: "Reviews, gameplay & gaming culture",
    accent: "#1e5c8a",
    icon: "◧",
  },
  {
    label: "Tier Lists",
    href: "/tier-lists",
    desc: "My takes, ranked definitively",
    accent: "#c0392b",
    icon: "◫",
  },
  {
    label: "Writing & Books",
    href: "/writing",
    desc: "Articles, essays & book reviews",
    accent: "#e8d5a0",
    icon: "◉",
  },
  {
    label: "Deep Thoughts",
    href: "/deep-thoughts",
    desc: "Philosophy, musings & job hunt",
    accent: "#9a8050",
    icon: "◎",
  },
  {
    label: "Homestead",
    href: "/homestead",
    desc: "The dream of simple, self-sufficient living",
    accent: "#1d9e75",
    icon: "◈",
  },
  {
